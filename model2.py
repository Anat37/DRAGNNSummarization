...
def build_decoder_model():
    ...
    master.add_component_decoder(PointerTBRU("pointer_final", False, 4*hidden_dim, VOCAB_SIZE + 2*ADDITIONAL_WORDS, "attention_layer", "context", "output", "decoder_input", "input", "decoder","lstm_state_layer", solid_modifiable=False).cuda())
    return master